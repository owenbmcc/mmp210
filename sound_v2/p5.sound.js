/** [p5.sound]  Version: 0.3.12 - 2020-10-29 */ 
 /**
...
/* harmony import */ var Tone_core_Tone__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
...
var audiocontext = __webpack_require__(5);
...
var processorNames = __webpack_require__(6);
...
p5.Signal = function (value) {
  var s = new Signal_default.a(value); // p5sound.soundArray.push(s);
...
Scale_default.a.prototype.setInput = Signal_default.a.prototype.setInput; // signals can add / mult / scale themselves
...
Signal_default.a.prototype.add = function (num) {
  var add = new Add_default.a(num); // add.setInput(this);
...
Signal_default.a.prototype.mult = function (num) {
  var mult = new Multiply_default.a(num); // mult.setInput(this);
